...
supervise: ## Watch the live deployment, restart what dies, publish status.json
	@./scripts/supervise.sh

health: ## One health pass (keeper, web, gas, feed) and print the result
	@./scripts/supervise.sh --once
